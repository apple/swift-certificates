...
/// ``_TinyArray1`` is a ``RandomAccessCollection`` optimised to store zero or one ``Element``.
...
public struct _TinyArray1<Element> {
    @usableFromInline
    enum Storage {
        case one(Element)
...
extension _TinyArray1: Equatable where Element: Equatable {}
extension _TinyArray1: Hashable where Element: Hashable {}
extension _TinyArray1: Sendable where Element: Sendable {}

extension _TinyArray1: RandomAccessCollection {
...
extension _TinyArray1.Storage: Equatable where Element: Equatable {
    @inlinable
...
extension _TinyArray1.Storage: Hashable where Element: Hashable {
    @inlinable
...
extension _TinyArray1.Storage: Sendable where Element: Sendable {}

extension _TinyArray1.Storage: RandomAccessCollection {
    @inlinable
