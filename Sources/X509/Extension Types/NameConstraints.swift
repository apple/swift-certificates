...
extension Certificate.Extensions.NameConstraints: Hashable { }

extension Certificate.Extensions.NameConstraints: Sendable { }
...
extension Certificate.Extensions.NameConstraints: CertificateExtensionConvertible {
...
struct NameConstraintsValue: DERImplicitlyTaggable {
    ...
    @inlinable
    init(_ ext: Certificate.Extensions.NameConstraints) {
